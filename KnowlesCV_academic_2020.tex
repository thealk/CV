...
\begin{rSubsection}{Western Graduate Research Scholarship}{2014 - 2019}{Value: approx. \$19,000 annually}{} %Current value: \$19,000 annually}{}
\end{rSubsection}
...
Sonderegger, M., Stuart-Smith, J., Macdonald, R., {\bf Knowles, T.}, \& Rathcke, T. (2020). Structured heterogeneity in Scottish stops. \emph{Language}.
...
%Adams, S. Kumar, N., Rizek, P., Hong, A., Zhang, J., Abeyesekera, A., Mancinelli, C., {\bf Knowles, T.} \& Jog, M.  (In review). Efficacy and acceptance of a Lombard-response device for hypophonia in Parkinson's disease.

{\bf Knowles, T.}, Adams, S., Page, A., Cushnie-Sparrow, D., \& Jog, M. (In review). A comparison of speech amplification and personal communication devices for hypophonia. Submitted to JSLHR.

Avenia, K., Ahmed, J., Borovsky, A., McRae, K., Jenkins, M., Sprengel, K., Fraser, J.A., Orange, J.B., {\bf Knowles, T.}, Roberts, A. (In prep). Predictive language comprehension in Parkinson’s disease.
...
\end{center}
	{\bf Knowles, T.}, Adams, S., \& Jog, M. Acoustic changes along a modified speech rate continuum in Parkinson's disease. Motor Speech Conference. Santa Barbar, CA. 02/2020. \emph{International poster presentation}
...
\begin{rSection}{Professional Experience: Clinical}
	...
	\item Lead LOUD Crowd therapy sessions for people with Parkinson's disease.
	\end{rSubsection}
...
% Academic job search committee member
% CDS Equipment fund member
...
\begin{rSection}{Professional Affiliations}
	...
	\end{rSubsection}
	\begin{rSubsection}{Movement Disorders Society}{2016 --- Present}{Member}{}
	\end{rSubsection}
