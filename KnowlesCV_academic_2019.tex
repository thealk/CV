...
Sonderegger, M., Stuart-Smith, J., Macdonald, R., {\bf Knowles, T.}, \& Rathcke, T. (submitted). Structured heterogeneity in Scottish stops.
...
\begin{rSection}{Professional Experience: Clinical}
	...
	\begin{rSubsection}{Student Clinician: Speech Amplification Clinic}{September 2018 - present}{H.A. Leeper Speech \& Hearing Clinic}{London, ON}
...
\begin{rSection}{Teaching Experience}
	...
	\begin{rSubsection}{Tutorial: Figuring out figures in R}{October 2018}{R-Ladies, London, Ontario Chapter}
...
%			\renewcommand\labelitemi{$\cdot$}
	...
	\item American Speech-Language-Hearing Association (ASHA) Special Interest Group 19: Member
\end{itemize}
\end{rSection}
